        ...
        <form name="AgregarCursoForm" action="datoscurso.jsp" method="GET">
            <table border="0" align="center">
                ...
                <tbody>
                     <tr>
                        <td>Codigo: </td>
                        <td><input type="text" name="f_codigo" maxlength="30" size="20" /></td>
                    </tr>
                    <tr>
                        <td>Nombre: </td>
                    ...
                    <tr>
                        <td>Horas: </td>
                        <td><input type="text" name="f_horas"  maxlength="8" size="8"/></td>
                    </tr>
                    <tr>
                        <td>Creditos: </td>
                        <td><input type="text" name="f_creditos"  maxlength="12" size="11"/></td>
                    </tr>
                    <tr>
                        <td>Estado: </td>
                        <td><input type="text" name="f_estado"  maxlength="1" size="2"/></td>
                    </tr>
                    <tr align="center">
                        <td colspan="2">
